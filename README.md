...
2. Run `npm install`. (needs NodeJS latest version to be installed on system)
3. Open `localhost:3000` in browser.
4. Run `npm run test` to run all test cases in watch mode.
5. Run `npm run test:coverage` to see test case code coverage report.
6. Run `npm run eslint` to run eslint and fix possible lint issues.
